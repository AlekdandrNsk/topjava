...
public class JdbcUserRepositoryImpl implements UserRepository {
    ...
    public User get(int id) {
        return setUserRoles(jdbcTemplate.query("SELECT * FROM users WHERE id=?", ROW_MAPPER, id));
    }

    @Override
    public User getByEmail(String email) {
        return setUserRoles(jdbcTemplate.query("SELECT * FROM users WHERE email=?", ROW_MAPPER, email));
    }
    ...
    public User setUserRoles(List<User> users) {
